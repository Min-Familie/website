...
<html>
    <head>
        ...
        <script async defer src="https://maps.googleapis.com/maps/api/js?key=BENDIKSKEY&parameters" type="text/javascript"></script>
    ...
    <body>
        ...
        <form action="newEvent.php"  method="post"   id="eventForm"> 
            ...
            <input  type="date"      name="day"  id="day"  <?php if (isset($_GET["day"])) {echo "value=".$_GET["day"];} ?>>
